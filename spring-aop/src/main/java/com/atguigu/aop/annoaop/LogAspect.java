...
public class LogAspect {
    ...
    * */
    ...
    @Before(value = "com.atguigu.aop.annoaop.LogAspect.pointCut()")
    ...
    @AfterReturning(value = "execution(public int com.atguigu.aop.annoaop.CalculatorImpl.*(..))",returning = "res")
    ...
    //重用切入点表达式
    @Pointcut(value = "execution(public int com.atguigu.aop.annoaop.CalculatorImpl.*(..))")
